...
> In this project we learned how to use a module inside a class. For this we created a class MyList and a module MyEnumerable. We implement our module MyEnumerable as a subset of the functionality of Enumerable.
...
```bash
  git clone "https://github.com/AbdelazizSoliman/Enumerables.git"
```
